...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private void loginJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginJButtonActionPerformed
        ...
        if(userAccount == null)
        {
            for(Network network : system.getNetworkList())
            {
                for(Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList())
                {
                    ...
                    Farmer farmer = inEnterprise.getFarmerDirectory().authenticateFarmer(userName,password);
                    if(farmer != null)
                    {
                        userAccount = farmer.getUserAccount();
                        inFarmer = farmer;
                        break;
                    }
                }
        ...
        if (userAccount == null && inFarmer == null) 
        {
            JOptionPane.showMessageDialog(null, "Invalid Credentails!");
            return;
        } 
        else if(inFarmer == null)
        {
            //System.out.println("Logged In user Id: " + userAccount.getEmployee().getId());
            container.add(userAccount.getRole().toString()+"workArea", userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inEnterprise, system, null, (LabOrganization)labOrganization));
        ...
        else if(inFarmer != null)
        {
            ...
            if(inEnterprise.getEnterpriseType().equals(Enterprise.EnterpriseType.Lab))
            {
                container.add("Lab"+userAccount.getRole().toString()+"workArea", userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inEnterprise, system, null, (LabOrganization)labOrganization));
                CardLayout layout = (CardLayout) container.getLayout();          
                layout.next(container);
            ...
            {
                container.add(userAccount.getRole().toString()+"workArea", userAccount.getRole().createWorkArea(container, userAccount, inOrganization, inEnterprise, system, inFarmer, (LabOrganization)labOrganization));
                CardLayout layout = (CardLayout) container.getLayout();          
                layout.next(container);
