...
import userinterface.HarvestingAdminRole.HarvestingAdminWorkAreaPanel;

/**
 *
 * @author Oza Sagar
 */
public class HarvestingOrganizationAdminRole extends Role
{
    ...
    {
        return new HarvestingAdminWorkAreaPanel(userProcessContainer, account, (HarvestingOrganization)organization, enterprise, system);
    }
